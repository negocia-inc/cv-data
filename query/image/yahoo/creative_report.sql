...
FROM `ida-prd.ipalette_optout.ydn_ad_image_assets` AS a
JOIN `ida-prd.ipalette_optout.ydn_ad_uploaded` AS b
ON a.ad_account_id = b.ad_account_id
AND a.campaign_id = b.campaign_id
AND a.ad_group_id = b.ad_group_id
AND a.ad_id = b.id
JOIN `ida-prd.ipalette_optout.ydn_ad` as c
